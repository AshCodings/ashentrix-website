  ...
  const executives = [
    {
      ...
      image: "/ashishjha.jpg",
      linkedin: "https://www.linkedin.com/in/ashish-k-jha-b9699545?utm_source=share_via&utm_content=profile&utm_medium=member_android",
      achievements: [
        "Business Strategy",
        "Market Leadership",
        "Innovation Focus",
    ...
    },
    {
      ...
      image: "/priyajha.jpg",
      linkedin: "https://www.linkedin.com/in/priya-jha-b3956a162?utm_source=share_via&utm_content=profile&utm_medium=member_ios",
      achievements: [
      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold mb-6">
            Executive
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#280b57] to-purple-400">
              {" "}
              Leadership
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 gap-6 max-w-4xl mx-auto">
          {executives.map((executive, index) => (
            <div
              key={index}
              className="group bg-gradient-to-br from-[#1a1625] to-[#280b57]/10 p-6 hover:shadow-lg transition-all duration-300 flex gap-6 items-center"
            >
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-[#9b87f5] font-semibold mb-4 uppercase tracking-wider text-sm">
                  {executive.role}
                </p>
