...
import { Send, MapPin, Globe, Phone, Clock, Mail,  } from "lucide-react";
...
const careerLinks = [
  { name: "Life at Ashentrix", href: "/life-at-ashentrix" },
...
export default function Footer() {
  return (
    <footer className="relative bg-[#0A0F1C] text-white overflow-hidden pt-16 sm:pt-20 lg:pt-16 pb-8 border-t border-gray-800">
